...
<%@ page import="com.test.util.DateAndTime"%>
	...
	<div class="panel panel-primary">
		  ...
		  <div class="panel-body">
				<s:iterator value="#request.messagelist"  id="id" status="st">  
                    
						     <div class="post">
                             <b> <s:property value="#id.from"/></b>:  <s:property value="#id.msg"/> <font style="color:BBBBBB"><s:property value="#id.sendtime"/> </font>
                             </div> 
					 </s:iterator>
		  </div>
		  <!-- <div class="panel-footer clearfix"><a href="showmsg.action?sno=" class="pull-right">更多</a></div> -->
	</div>
	<div class="panel panel-default">
		<div class="panel-body">
